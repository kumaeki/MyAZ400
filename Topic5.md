...
<details>
    <summary>answer</summary>
    Convert the .docx file to : B. Markdown (.md)<br/>
    Convert the flow charts to : A. Mermaid diagrams<br/>
</details>
...
<details>
    <summary>answer</summary>
    E. Prepare Analysis Configuration<br/>
    D. Visual Studio Build<br/>
    B. Visual Studio Test<br/>
    A. Run Code Analysis<br/>
</details>
...
<details>
    <summary>answer</summary>
    B. Integrate Azure DevOps and SonarQube.<br/>
</details>
...
<details>
    <summary>answer</summary>
    C. Create a dependency graph for the application<br/>
    A. Group the related components<br/>
    B. Assign ownership to each component group<br/>
</details>
...
<details>
    <summary>answer</summary>
    B. In a Maven build task, select Run PMD.<br/>
...
<details>
    <summary>answer</summary>
    B. Create a new feed in Azure Artifacts.<br/>
    A. Publish the package to a feed.<br/>
    E. Add the package URL to the NuGet Package Manager settings in Visual Studio.<br/>
</details>
...
<details>
    <summary>answer</summary>
    A. the git filter-repo command<br/>
    B. BFG Repo-Cleaner<br/>
...
<details>
    <summary>answer</summary>
    D. From Import a Git repository, click Import.<br/>
    <a href = "https://learn.microsoft.com/en-us/azure/devops/repos/git/import-git-repository?view=azure-devops">Import a Git repo</a>
</details>
...
<details>
    <summary>answer</summary>
    A. In a Maven build task, select Run PMD.<br/>
    <a href="https://pmd.github.io/">PMD</a>
</details>
...
<details>
    <summary>answer</summary>
     C. the Source control settings for the Automation account.<br/>
</details>
...
<details>
    <summary>answer</summary>
     A. Add the name of the default branch to the on: push specification in the code scanning workflow.<br/>
     D. Update the code in the pull request.<br/>
</details>
...
<details>
    <summary>answer</summary>
     C. git clone --bare https://github.com/contoso/project.git<br/>
     B. cd project1<br/>
     F. git push --mirror https://github.com/contoso/project.git<br/>
</details>
...
<details>
    <summary>answer</summary>
    git reflog expire --expire-unreachable=now --all<br/>
    git gc --prune=now
</details>
...
<details>
    <summary>answer</summary>
    F. Create SSH keys by using ssh-keygen<br/>
    A. Sign in to Azure DevOps.<br/>
    B. Add the SSH public key..<br/>
    C. Clone repo1.
</details>
...
<details>
    <summary>answer</summary>
    B. git log<br/>
    C. git checkout [hash]~1 --path/to/file<br/>
    E. git restore path/to/file<br/>
</details>
...
<details>
    ...
    git restore --source main~3 App.exe.config<br/>
